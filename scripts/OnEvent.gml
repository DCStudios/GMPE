...
//  --  Get the arguments
    ...
    var O,T,C;
    if( argument_count != 3 ) show_error( "OnEvent: Wrong number of arguments!", true );
...
//  --  Validate the arguments
    ...
    if( !is_string( T ) ) show_error( "OnEvent: Event type must be a string!", true );
...
//  --  Add listener
    ...
    if( ds_map_exists( O.Listeners, T ) ) CL = O.Listeners[? T];
